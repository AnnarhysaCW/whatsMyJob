...
const Home = () => {
  ...
  const initialJobs = [
    { id: 1, title: "AI Engineer", descriptions: [] },
    { id: 2, title: "Data Storyteller", descriptions: [] },
    { id: 3, title: "Prompt Designer", descriptions: [] },
    { id: 4, title: "Growth Hacker", descriptions: [] },
    { id: 5, title: "Edge Specialist", descriptions: [] },
    { id: 6, title: "Metaverse Builder", descriptions: [] },
    { id: 7, title: "Carbon Curator", descriptions: [] },
    { id: 8, title: "Trend Analyst", descriptions: [] },
    { id: 9, title: "Digital Nomad", descriptions: [] },
    { id: 10, title: "Culture Coach", descriptions: [] },
    { id: 11, title: "Wellness Guide", descriptions: [] },
    { id: 12, title: "Learning Designer", descriptions: [] },
    { id: 13, title: "Experience Curator", descriptions: [] },
    { id: 14, title: "Avatar Stylist", descriptions: [] },
    { id: 15, title: "Remote Manager", descriptions: [] },
    { id: 16, title: "Ethics Officer", descriptions: [] },
    { id: 17, title: "Humanization Lead", descriptions: [] },
    { id: 18, title: "Insight Partner", descriptions: [] },
    { id: 19, title: "Software Engineer", descriptions: [] },
    { id: 20, title: "Graphic Designer", descriptions: [] },
  ];
